...
local Window = OrionLib:MakeWindow({Name = "ZyHub", HidePremium = false, IntroText = "ZyHub⚜️", SaveConfig = true, ConfigFolder = "ZyHubFunny"})
...
W:AddLabel("[✓]Join My Discord for more info about ZyHub")
local Section = W:AddSection({
    Name = "Status"
})
...
CDK:AddParagraph("List Nhiệm vụ song kiếm oden")
CDK:AddParagraph("[✔️Quan trọng nhất : là tushita Và yama phải 350 mastery!")
CDK:AddParagraph("[🤣]mỗi khi bạn làm xong nhiệm vụ nếu thành. công bạn sẽ nhận đc 1 nguyên thạch")
CDK:AddParagraph("Nếu chỗ lấy cdk ko mở cửa thì bạn hãy nói chuyện với Crypt Master để mở cửa")
CDK:AddParagraph("nhiệm vụ 1 [Yama]","Đau Đớn và đau khổ | bạn Cho phép bất kỳ NPC hoặc Kẻ thù nào đánh bạn cho đến khi thanh máu của bạn đạt mức rất thấp")
CDK:AddParagraph("nhiệm vụ 2 [Yama]","Giết tất cả quái trên mọi hòn đảo có dấu màu tím xung quanh chúng, bao gồm cả Đảo Rùa Nổi.  [(lưu ý hãy bật haki quan sát để dễ thấy hơn)] |lưu ý nhiệm vụ này xuất hiện trong cả nơi lấy yama[chú ý]")
CDK:AddParagraph("nhiệm vụ 3 [Yama]","Sử dụng xương[bone] để random ra linh hồn bóng tối và spawn ra và để soul reaper giết sau đó được lên thiên đường |thắp sáng đuốc và giết quái xong cửa thiên đường sẽ mở và bạn sẽ thành công")
CDK:AddParagraph("---------------------------------Nhiệm vụ Tushita---------------------------------------------")
CDK:AddParagraph("[nhiệm vụ 1 [Tushita]"," Huyền thoại bến tàu : Nói chuyện với ba người bán thuyền khác nhau trên ba hòn đảo. Tương tác với họ cho đến khi bạn thấy chữ [(Pardon Me)] {nếu sai chính tả thì xin lỗi}  ")
CDK:AddParagraph("[nhiệm vụ 2 [Tushita]"," Sense of Duty | đánh 1 raid caslte và hoàn thành")
CDK:AddParagraph("[nhiệm vụ 3 [Tushita]"," Vô hồn | Đánh bại boss big mom dưới 2 phút nếu thành công bạn sẽ lên thiên đường thắp đuốc và đánh quái ")
...
OrionLib:MakeNotification({
    Name = "ZyHub",
    Content = "Load config Thành công!!!!🤣",
    Image = "rbxassetid://8192162908",
    Time = 5
})	